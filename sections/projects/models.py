...
class Projects(models.Model):
    user = models.ForeignKey(Profile)                           #user that created project
...
class Project(models.Model):
    ...
    user = models.ForeignKey(Profile)                           #user that made the change/update
...
class ProjectMembers(models.Model):
    user = models.ManyToManyField(Profile)                      #User referencing
